...
namespace Picsart
{
    public partial class VideoMetadataClient
    {
        ...
        private static readonly global::Picsart.EndPointSecurityRequirement s_VideoSetThumbnailGetresultSecurityRequirement0 =
        ...
        private static readonly global::Picsart.EndPointSecurityRequirement[] s_VideoSetThumbnailGetresultSecurityRequirements =
            new global::Picsart.EndPointSecurityRequirement[]
            {                s_VideoSetThumbnailGetresultSecurityRequirement0,
            };
        partial void PrepareVideoSetThumbnailGetresultArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string transactionId);
        partial void PrepareVideoSetThumbnailGetresultRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string transactionId);
        partial void ProcessVideoSetThumbnailGetresultResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessVideoSetThumbnailGetresultResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Picsart.VideoSetThumbnailGetresultResponse> VideoSetThumbnailGetresultAsync(
            string transactionId,
            global::Picsart.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await VideoSetThumbnailGetresultAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Picsart.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Picsart.AutoSDKHttpResponse<global::Picsart.VideoSetThumbnailGetresultResponse>> VideoSetThumbnailGetresultAsResponseAsync(
            string transactionId,
            global::Picsart.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareVideoSetThumbnailGetresultArguments(
            ...
            var __authorizations = global::Picsart.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                operationName: "VideoSetThumbnailGetresultAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Picsart.PathBuilder(
                                path: $"/video/metadata/thumbnail/{transactionId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareVideoSetThumbnailGetresultRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Picsart.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Picsart.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VideoSetThumbnailGetresult",
                                methodName: "VideoSetThumbnailGetresultAsync",
                                pathTemplate: "$\"/video/metadata/thumbnail/{transactionId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessVideoSetThumbnailGetresultResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Picsart.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessVideoSetThumbnailGetresultResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Picsart.VideoSetThumbnailGetresultResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Picsart.AutoSDKHttpResponse<global::Picsart.VideoSetThumbnailGetresultResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Picsart.VideoSetThumbnailGetresultResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
