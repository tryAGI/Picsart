...
namespace Picsart
{
    public partial class GenAIText2ImageClient
    {
        ...
        private static readonly global::Picsart.EndPointSecurityRequirement s_GenaiGenerateLogoSecurityRequirement0 =
        ...
        private static readonly global::Picsart.EndPointSecurityRequirement[] s_GenaiGenerateLogoSecurityRequirements =
            new global::Picsart.EndPointSecurityRequirement[]
            {                s_GenaiGenerateLogoSecurityRequirement0,
            };
        partial void PrepareGenaiGenerateLogoArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Picsart.AllOf<global::Picsart.GenAILogoParameters, global::Picsart.GenAILogoModels> request);
        partial void PrepareGenaiGenerateLogoRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Picsart.AllOf<global::Picsart.GenAILogoParameters, global::Picsart.GenAILogoModels> request);
        partial void ProcessGenaiGenerateLogoResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenaiGenerateLogoResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Picsart.GenaiGenerateLogoResponse> GenaiGenerateLogoAsync(

            global::Picsart.AllOf<global::Picsart.GenAILogoParameters, global::Picsart.GenAILogoModels> request,
            global::Picsart.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GenaiGenerateLogoAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Picsart.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Picsart.AutoSDKHttpResponse<global::Picsart.GenaiGenerateLogoResponse>> GenaiGenerateLogoAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGenaiGenerateLogoArguments(
            ...
            var __authorizations = global::Picsart.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenaiGenerateLogoSecurityRequirements,
                operationName: "GenaiGenerateLogoAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenaiGenerateLogoRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Picsart.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Picsart.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenaiGenerateLogo",
                                methodName: "GenaiGenerateLogoAsync",
                                pathTemplate: "\"/genai/logo\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenaiGenerateLogoResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Picsart.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenaiGenerateLogoResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Picsart.GenaiGenerateLogoResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Picsart.AutoSDKHttpResponse<global::Picsart.GenaiGenerateLogoResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Picsart.GenaiGenerateLogoResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Picsart.GenaiGenerateLogoResponse> GenaiGenerateLogoAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Picsart.AllOf<global::Picsart.GenAILogoParameters, global::Picsart.GenAILogoModels>
            {
            };

            return await GenaiGenerateLogoAsync(
                request: __request,
                requestOptions: requestOptions,
