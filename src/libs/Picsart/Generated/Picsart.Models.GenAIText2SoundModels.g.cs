...
namespace Picsart
{
    ...
    public sealed partial class GenAIText2SoundModels
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Picsart.JsonConverters.GenAIText2SoundModelsModelJsonConverter))]
        public global::Picsart.GenAIText2SoundModelsModel? Model { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenAIText2SoundModels" /> class.
        /// </summary>
        /// <param name="model">
        /// Optionally choose a specific AI model to use for this audio generation.<br/>
        /// If not specified, a default model will be applied. Please note that the default model may change over time as Picsart continues to improve performance and accuracy. Any change to the default will be made only after thorough testing and validation to ensure it delivers better results.<br/>
        ...
        public GenAIText2SoundModels(
            global::Picsart.GenAIText2SoundModelsModel? model)
        {
            this.Model = model;
        }
