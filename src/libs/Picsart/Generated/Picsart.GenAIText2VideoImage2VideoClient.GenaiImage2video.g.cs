...
namespace Picsart
{
    public partial class GenAIText2VideoImage2VideoClient
    {
        ...
        private static readonly global::Picsart.EndPointSecurityRequirement s_GenaiImage2videoSecurityRequirement0 =
        ...
        private static readonly global::Picsart.EndPointSecurityRequirement[] s_GenaiImage2videoSecurityRequirements =
            new global::Picsart.EndPointSecurityRequirement[]
            {                s_GenaiImage2videoSecurityRequirement0,
            };
        partial void PrepareGenaiImage2videoArguments(
        ...
        partial void PrepareGenaiImage2videoRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Picsart.AllOf<global::Picsart.GenAIImageParameters, global::Picsart.GenAIText2VideoParameters, global::Picsart.GenAIImage2VideoModels> request);
        partial void ProcessGenaiImage2videoResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenaiImage2videoResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GenaiImage2videoAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Picsart.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Picsart.AutoSDKHttpResponse<global::Picsart.GenaiImage2videoResponse>> GenaiImage2videoAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGenaiImage2videoArguments(
            ...
            var __authorizations = global::Picsart.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenaiImage2videoSecurityRequirements,
                operationName: "GenaiImage2videoAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenaiImage2videoRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Picsart.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Picsart.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenaiImage2video",
                                methodName: "GenaiImage2videoAsync",
                                pathTemplate: "\"/genai/image2video\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Picsart.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenaiImage2videoResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Picsart.GenaiImage2videoResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Picsart.AutoSDKHttpResponse<global::Picsart.GenaiImage2videoResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Picsart.GenaiImage2videoResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await GenaiImage2videoAsync(
                request: __request,
                requestOptions: requestOptions,
