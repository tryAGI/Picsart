...
namespace Picsart
{
    ...
    public sealed partial class GenAIText2ImageModels
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Picsart.JsonConverters.GenAIText2ImageModelsModelJsonConverter))]
        public global::Picsart.GenAIText2ImageModelsModel? Model { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenAIText2ImageModels" /> class.
        /// </summary>
        /// <param name="model">
        /// Optionally choose a specific AI model to use for this request.<br/>
        /// If not specified, a default model will be applied. Please note that the default model may change over time as Picsart continues to improve performance and accuracy. Any change to the default will be made only after thorough testing and validation to ensure it delivers better results.<br/>
        ...
        public GenAIText2ImageModels(
            global::Picsart.GenAIText2ImageModelsModel? model)
        {
            this.Model = model;
        }
