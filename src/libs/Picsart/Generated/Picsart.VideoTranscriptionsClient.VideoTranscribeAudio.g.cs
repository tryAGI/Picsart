...
namespace Picsart
{
    public partial class VideoTranscriptionsClient
    {


        private static readonly global::Picsart.EndPointSecurityRequirement s_VideoTranscribeAudioSecurityRequirement0 =
        ...
        private static readonly global::Picsart.EndPointSecurityRequirement[] s_VideoTranscribeAudioSecurityRequirements =
            new global::Picsart.EndPointSecurityRequirement[]
            {                s_VideoTranscribeAudioSecurityRequirement0,
            };
        partial void PrepareVideoTranscribeAudioArguments(
        ...
        partial void PrepareVideoTranscribeAudioRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Picsart.AllOf<global::Picsart.VideoTranscribeFileParameters, global::Picsart.VideoTranscribeParameters> request);
        partial void ProcessVideoTranscribeAudioResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        {
            var __response = await VideoTranscribeAudioAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Picsart.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Picsart.AutoSDKHttpResponse<global::Picsart.VideoTranscribeAudioResponse>> VideoTranscribeAudioAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareVideoTranscribeAudioArguments(
            ...
            var __authorizations = global::Picsart.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_VideoTranscribeAudioSecurityRequirements,
                operationName: "VideoTranscribeAudioAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareVideoTranscribeAudioRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Picsart.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Picsart.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VideoTranscribeAudio",
                                methodName: "VideoTranscribeAudioAsync",
                                pathTemplate: "\"/video/audio/transcribe\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessVideoTranscribeAudioResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Picsart.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessVideoTranscribeAudioResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Picsart.VideoTranscribeAudioResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Picsart.AutoSDKHttpResponse<global::Picsart.VideoTranscribeAudioResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Picsart.VideoTranscribeAudioResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await VideoTranscribeAudioAsync(
                request: __request,
                requestOptions: requestOptions,
