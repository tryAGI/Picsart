...
namespace Picsart
{
    public partial class VideoVideoEnhancementClient
    {
        ...
        private static readonly global::Picsart.EndPointSecurityRequirement s_VideoUpscaleFpsSecurityRequirement0 =
        ...
        private static readonly global::Picsart.EndPointSecurityRequirement[] s_VideoUpscaleFpsSecurityRequirements =
            new global::Picsart.EndPointSecurityRequirement[]
            {                s_VideoUpscaleFpsSecurityRequirement0,
            };
        partial void PrepareVideoUpscaleFpsArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Picsart.VideoVideoParameters request);
        partial void PrepareVideoUpscaleFpsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Picsart.VideoVideoParameters request);
        partial void ProcessVideoUpscaleFpsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessVideoUpscaleFpsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await VideoUpscaleFpsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Picsart.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Picsart.AutoSDKHttpResponse<global::Picsart.VideoUpscaleFpsResponse>> VideoUpscaleFpsAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareVideoUpscaleFpsArguments(
            ...
            var __authorizations = global::Picsart.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_VideoUpscaleFpsSecurityRequirements,
                operationName: "VideoUpscaleFpsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Picsart.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Picsart.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VideoUpscaleFps",
                                methodName: "VideoUpscaleFpsAsync",
                                pathTemplate: "\"/video/upscale/fps\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessVideoUpscaleFpsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Picsart.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessVideoUpscaleFpsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Picsart.VideoUpscaleFpsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Picsart.AutoSDKHttpResponse<global::Picsart.VideoUpscaleFpsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Picsart.VideoUpscaleFpsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
