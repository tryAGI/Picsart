...
namespace Picsart
{
    ...
    public sealed partial class GenAIImage2VideoModels
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Picsart.JsonConverters.GenAIImage2VideoModelsModelJsonConverter))]
        public global::Picsart.GenAIImage2VideoModelsModel? Model { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenAIImage2VideoModels" /> class.
        /// </summary>
        /// <param name="model">
        /// Optionally choose a specific AI model to use for this video generation.<br/>
        /// If not specified, a default model will be applied. Please note that the default model may change over time as Picsart continues to improve performance and accuracy. Any change to the default will be made only after thorough testing and validation to ensure it delivers better results.<br/>
        ...
        public GenAIImage2VideoModels(
            global::Picsart.GenAIImage2VideoModelsModel? model)
        {
            this.Model = model;
        }
